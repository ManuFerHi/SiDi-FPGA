...
**firmware must be updated to release 2018-08-10 or later for correct OSD and disk functionality!**

### Installation:
Copy the *.rbf file at the root of the SD card. You can rename the file to core.rbf if you want to load it automatically at startup.
Copy samcoupe.rom file to the root of SD card.
